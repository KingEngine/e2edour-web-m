$(function () {
    var page = {
        location: {
            queryForPage: "settingManger/frontManager/navigationManager/queryForPage",
            addData: "settingManger/frontManager/navigationManager/addData",
            deleteData: "settingManger/frontManager/navigationManager/deleteData",
            queryOne: "settingManger/frontManager/navigationManager/queryOne",
            updateData: "settingManger/frontManager/navigationManager/updateData",
        },
        init: function () {
            this.bindUI();
        },
                    ...
                    formatters: {
                        "operation": function (column, row) {
                            return "<i class=\"btn btn-xs btn-success glyphicon glyphicon-pencil\" data-row-id=\"" + row.id + "\" />" +
                                ...
                                +"&nbsp;&nbsp;&nbsp;&nbsp;<i class=\"btn btn-xs btn-warning  glyphicon glyphicon-zoom-in\" data-row-id=\"" + row.id + "\" />";
                        }
                    }
